...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Matthew </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-matthew-records.css?v=<?php echo time(); ?>">
