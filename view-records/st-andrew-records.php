...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Andrew </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-Andrew-records.css?v=<?php echo time(); ?>">
