...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Bartolomew </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-bartolomew-records.css?v=<?php echo time(); ?>">
                    ...
                    <div class = "map-header-with-bck">
                        ...
                        <div class = "bootstrap"> <!-- Content Wrapper -->
                            ...
                            <table id = "example" class = "table table-striped">
                                ...
                                <tbody>
                                    <!-- PHP Connection -->
                                    <?php // View St. bartolomew Records
                                        ...
                                        echo "<tr>
                                            ...
                                            <td> 
                                                <div class = \"action-wrapper\">
                                                    <a href = \"../connect/update.php?update_id=$id&table=$table&del=$del\"title=\"Update\"><i class='bx bx-edit' name = \"update\"></i></a>
