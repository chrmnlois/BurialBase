...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Thomas </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-thomas-records.css?v=<?php echo time(); ?>">
                                        ...
                                        echo "<tr>
                                            ...
                                            <td> 
                                                <div class = \"action-wrapper\">
                                                    <a href = \"../connect/update.php?update_id=$id&table=$table&del=$del&nid=$niche_ID&nid=$niche_ID\"title=\"Update\"><i class='bx bx-edit' name = \"update\"></i></a>
