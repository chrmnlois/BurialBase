...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Thaddaeus </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-thaddaeus-records.css?v=<?php echo time(); ?>">
