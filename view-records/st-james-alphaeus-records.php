...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. James Son of Alphaeus </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-james-alphaeus-records.css?v=<?php echo time(); ?>">
                    ...
                    <div class = "map-header-with-bck">
                        ...
                        <div class = "bootstrap"> <!-- Content Wrapper -->
                            ...
                            <table id = "example" class = "table table-striped">
                                ...
                                <tbody>
                                    <!-- PHP Connection -->
                                    <?php // View St. James Son of Alphaeus Records
                                    ...
                                    $sql = "SELECT * FROM st_james_alphaeus";
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        $table = "St. James Son of Alphaeus";
                                        $del = 'st_james_alphaeus';
                                        $id = $row["id"];
