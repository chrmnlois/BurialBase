...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Records - St. Philip </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-philip-records.css?v=<?php echo time(); ?>">
                                        ...
                                        echo "<tr>
                                            ...
                                            <td> 
                                                <div class = \"action-wrapper\">
                                                    <a href = \"../connect/update.php?update_id=$id&nid=$niche_ID&table=$table&del=$del\"title=\"Update\"><i class='bx bx-edit' name = \"update\"></i></a>
