<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_thaddaeus";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. Thaddaeus </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-thaddaeus-map.css?v=<?php echo time(); ?>">
                        ...
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-header-with-bck">
                                ...
                                <div class = "map-name-add">
                                    <h2 class = "map-title"> St. Thaddaeus - 2F</h2>
                                    <h6 class = "map-detail"> Niche Layout </h6>
                                </div>
                            </div>

                            <div class = "map-content-wrapper"> <!-- St Thaddaeus Map Wrapper -->

                                <!-- St. Thaddaeus Map -->
                                <div class = "st-thaddaeus-map"> 
                                    ...
                                    <table class = "st-thaddaeus-columns">
                                    <thead>
                                            <tr>
