<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_john";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. John </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-john-map.css?v=<?php echo time(); ?>">
                        ...
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-header-with-bck">
                                ...
                                <div class = "map-name-add">
                                    <h2 class = "map-title"> St. John - 1A</h2>
                                    <h6 class = "map-detail"> Niche Layout </h6>
                                </div>
                            </div>

                            <div class = "map-content-wrapper"> <!-- St John Map Wrapper -->

                                <!-- St. John Map -->
                                <div class = "st-john-map"> 
