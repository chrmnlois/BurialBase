<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_james";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. James </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-james-map.css?v=<?php echo time(); ?>">
                        ...
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-header-with-bck">
                                ...
                                <div class = "map-name-add">
                                    <h2 class = "map-title"> St. James - 1B</h2>
