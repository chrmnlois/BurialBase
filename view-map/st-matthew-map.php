<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_matthew";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. Matthew </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-matthew-map.css?v=<?php echo time(); ?>">
                        ...
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-header-with-bck">
                                ...
                                <div class = "map-name-add">
                                    <h2 class = "map-title"> St. Matthew - 2D</h2>
                                    <h6 class = "map-detail"> Niche Layout </h6>
                                </div>
                            </div>

                            <div class = "map-content-wrapper"> <!-- St Matthew Map Wrapper -->

                                <!-- St. Matthew Map -->
                                <div class = "st-matthew-map"> 
                                    ...
                                    <table class = "st-matthew-columns">
                                    <thead>
                                            <tr>
