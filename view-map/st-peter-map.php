<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_peter";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. Peter </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-peter-map.css?v=<?php echo time(); ?>">
                ...
                <div class = "container"> <!-- Webpage Main Content Wrapper -->
                    <div class = "content-box"> <!-- Content Box Wrapper -->
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-content-wrapper"> <!-- St Peter Map Wrapper -->

                                <!-- St. Peter Map -->
                                <div class = "st-peter-map"> 
