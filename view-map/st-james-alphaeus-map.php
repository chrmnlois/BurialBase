<?php
    ...
    function fetchAllDataFromDatabase($connection) {
        ...
        $sql = "SELECT niche_ID, full_name, birth_date, death_date FROM st_james_alphaeus";
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Webpage Title -->
        <title> View Map - St. James Son of Alphaeus </title>

        <!-- CSS Link -->
        <link rel="stylesheet" href="../style/st-james-alphaeus-map.css?v=<?php echo time(); ?>">
                        ...
                        <div class = "map-box"> <!-- Content Wrapper -->
                            ...
                            <div class = "map-header-with-bck">
                                ...
                                <div class = "map-name-add">
                                    <h2 class = "map-title"> St. James Son of Alphaeus - 2E</h2>
                                    <h6 class = "map-detail"> Niche Layout </h6>
                                </div>
                            </div>

                            <div class = "map-content-wrapper"> <!-- St james Map Wrapper -->

                                <!-- St. james Map -->
                                <div class = "st-james-alphaeus-map"> 
                                    ...
                                    <table class = "st-james-alphaeus-columns">
                                    <thead>
                                            <tr>
                                                ...
                                                <th class = "column-ten"> 10 </th>
                                                <th class = "column-eleven"> 11 </th>
                                                <th class = "column-twelve"> 12 </th>
                                                <th class = "column-thirteen"> 13 </th>
                                                <th class = "column-fourteen"> 14 </th>
                                            </tr>
                                        </thead>  
